...
export const categories = [
  ...
  { cate: "nutrition", category_id: "nutrition", icon: Nut },
  { cate: "fitness", category_id: "fitness", icon: Fit },
  { cate: "sleep", category_id: "sleep", icon: Sleep },
  ...
  { cate: "oral health", category_id: "oral-health", icon: Heart },
